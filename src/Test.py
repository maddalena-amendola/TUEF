...
from Utils import read_json, extract_features, join_layer_experts, evaluate_pred, parse_arguments
...
def evaluate(data_dir, struc_dir, n_samples, threshold, restart, n_steps):
    ...
    pickle.dump(ground_truth, open(struc_dir + 'ground_truth', 'wb'))
    pickle.dump(results, open(struc_dir + 'measures', 'wb'))
