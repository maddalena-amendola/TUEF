...
def TUEFNORW(data_name, label, ltr_size, max_evals, test_size):
    
    print('Starting TUEF NO Random-Walk (TUEFNORW) baseline')
    
    data_dir = f'./Dataset/{data_name}/{label}/data/'
    struc_dir = f'./Dataset/{data_name}/{label}/structures/'
    baseline_dir = f'./Dataset/{data_name}/{label}/Baselines/TUEFNORW/structures/'
...
if __name__ == "__main__":
    ...
    TUEFNORW(data_name, label, ltr_samples, max_evals, test_samples)
