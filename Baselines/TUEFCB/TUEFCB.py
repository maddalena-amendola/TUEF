...
def TUEFCB(data_name, label, ltr_size, max_evals, test_size):
    ...
    print('Starting TUEF Content-Based (TUEFCB) baseline')
    
    data_dir = f'./Dataset/{data_name}/{label}/data/'
    struc_dir = f'./Dataset/{data_name}/{label}/structures/'
    baseline_dir = f'./Dataset/{data_name}/{label}/Baselines/TUEFCB/structures/'
...
if __name__ == "__main__":
    ...
    TUEFCB(data_name, label, ltr_samples, max_evals, test_samples)
